...
def main():
    ...
    kaggle_link = '[data]((https://www.kaggle.com/datasets/d4rklucif3r/restaurant-reviews)'   
    st.markdown('It does this by training a machine learning model on an open' + kaggle_link + 'source with prelabled reviews.', unsafe_allow_html=Tru)
